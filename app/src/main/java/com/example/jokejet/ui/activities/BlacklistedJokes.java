...
public class BlacklistedJokes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blacklisted_jokes);
        ...
        List<Joke> jokes = jr.getAllJokes("blacklisted");
        RecyclerView recyclerView = findViewById(R.id.blacklistedJokesRecyclerView);
        ...
        ImageButton back = findViewById(R.id.backBlacklistedButton);
